...
public class OutsideObjOSSAInstruction extends SSAInstruction{

//	public SSAInstruction originst;
	public OSSAObject nwobj;
	
	public OutsideObjOSSAInstruction(OSSAObject nwobj) {
		this.nwobj = nwobj;
//		this.originst = originst;
	...
	public String toString(SymbolTable symbolTable) {
		// TODO Auto-generated method stub
		StringBuffer strbuff = new StringBuffer(nwobj+" = outsideObj()");
